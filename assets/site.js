(() => {
  ...
  const translations = new Map([
    ...
    ["Filme, die", "Films that"], ["bleiben.", "stay."], ["Erzähl uns,", "Tell us,"], ["was entstehen soll.", "what you want to create."], ["Film, der", "Film that"], ["nicht nur läuft.", "does more than play."], ["Sondern bleibt.", "It stays."],
