...
export function buildInvoiceEmail(invoice: Invoice, settings: Settings) {
  ...
  return `<!doctype html><html lang="de"><head><meta charset="utf-8"><meta name="color-scheme" content="dark light"><style>body{margin:0;padding:0;background:#090a08;color:#eeeae0;font-family:Arial,Helvetica,sans-serif}a{color:inherit}table{border-collapse:collapse} @media only screen and (max-width:620px){.page{width:100%!important}.pad{padding-left:22px!important;padding-right:22px!important}.nav{display:none!important}.hero-title{font-size:46px!important;line-height:.94!important}.split{display:block!important;width:100%!important;padding-left:0!important;padding-right:0!important;text-align:left!important}.amount{font-size:26px!important}}</style></head><body><table role="presentation" width="100%" bgcolor="#090a08"><tr><td align="center"><table role="presentation" class="page" width="680" style="width:100%;max-width:680px;background:#090a08"><tr><td class="pad" style="padding:30px 42px 24px;border-bottom:1px solid #343531"><table role="presentation" width="100%"><tr><td style="font-size:22px;font-weight:bold;letter-spacing:-1px">HEAV<span style="color:#d7ff38">.</span></td><td class="nav" align="right" style="font-size:9px;letter-spacing:1.7px;color:#aaa89f;white-space:nowrap">LEISTUNGEN&nbsp;&nbsp;&nbsp; ARBEITEN&nbsp;&nbsp;&nbsp; ÜBER UNS&nbsp;&nbsp;&nbsp; MICHIAS</td></tr></table></td></tr><tr><td class="pad" style="padding:70px 42px 68px;background:#090a08"><table role="presentation" width="100%"><tr><td style="padding-bottom:24px;color:#d7ff38;font-size:10px;font-weight:bold;letter-spacing:2px">—&nbsp;&nbsp; RECHNUNG · ${reference}</td></tr><tr><td class="hero-title" style="font-size:68px;line-height:.9;letter-spacing:-3px;font-weight:bold;color:#eeeae0">Gute Arbeit.<br><span style="font-family:Georgia,serif;font-weight:normal;font-style:italic;color:#d7ff38;letter-spacing:-2px">Klare Zahlen.</span></td></tr><tr><td style="padding-top:28px;color:#aaa89f;font-size:15px;line-height:1.65">Hallo ${greeting}<br><br>Vielen Dank für die Zusammenarbeit. Im Anhang findest du die vollständige Rechnung als PDF mit Swiss-QR-Zahlteil.</td></tr></table></td></tr><tr><td class="pad" style="padding:40px 42px 48px;background:#eeeae0;color:#090a08"><table role="presentation" width="100%"><tr><td class="split" width="52%" valign="top" style="padding-right:24px"><div style="font-size:10px;font-weight:bold;letter-spacing:1.8px;color:#6f6e69">REFERENZNUMMER</div><div style="padding-top:10px;font-size:17px;font-weight:bold;letter-spacing:.3px">${reference}</div><div style="padding-top:26px;font-size:10px;font-weight:bold;letter-spacing:1.8px;color:#6f6e69">RECHNUNGSDATUM</div><div style="padding-top:8px;font-size:14px">${issueDate}</div></td><td class="split" width="48%" valign="top" align="right" style="padding-left:24px"><div style="font-size:10px;font-weight:bold;letter-spacing:1.8px;color:#6f6e69">TOTAL</div><div class="amount" style="padding-top:7px;font-size:30px;font-weight:bold;letter-spacing:-1px">${amount}</div><div style="padding-top:26px;font-size:10px;font-weight:bold;letter-spacing:1.8px;color:#6f6e69">ZAHLBAR BIS</div><div style="padding-top:8px;font-size:14px">${dueDate}</div></td></tr></table><table role="presentation" width="100%" style="margin-top:46px;border-top:1px solid #090a08"><thead><tr><th align="left" style="padding:12px 0 10px;font-size:9px;letter-spacing:1.5px">LEISTUNG</th><th align="center" style="padding:12px 5px 10px;font-size:9px;letter-spacing:1.5px">MENGE</th><th align="right" style="padding:12px 5px 10px;font-size:9px;letter-spacing:1.5px">EINZELPREIS</th><th align="right" style="padding:12px 0 10px;font-size:9px;letter-spacing:1.5px">BETRAG</th></tr></thead><tbody>${itemRows}</tbody></table><table role="presentation" width="100%" style="margin-top:22px;border-top:1px solid #090a08"><tr><td align="right" style="padding-top:12px;color:#6f6e69;font-size:13px">Zwischensumme</td><td align="right" width="150" style="padding-top:12px;font-size:13px">${escapeHtml(formatCHF(invoice.subtotal_rappen))}</td></tr><tr><td align="right" style="padding-top:8px;color:#6f6e69;font-size:13px">${taxLabel}</td><td align="right" style="padding-top:8px;font-size:13px">${invoice.tax_rappen ? escapeHtml(formatCHF(invoice.tax_rappen)) : ""}</td></tr><tr><td align="right" style="padding-top:16px;border-top:2px solid #090a08;font-size:15px;font-weight:bold">TOTAL</td><td align="right" style="padding-top:16px;border-top:2px solid #090a08;font-size:15px;font-weight:bold">${amount}</td></tr></table><table role="presentation" width="100%" style="margin-top:34px;background:#bec6b7"><tr><td style="padding:18px 20px;color:#090a08;font-size:13px;line-height:1.55">Bitte verwende bei der Zahlung die Referenznummer <strong>${reference}</strong>.<br>Sie stimmt mit dem Swiss-QR-Code im PDF überein.</td></tr></table></td></tr><tr><td class="pad" style="padding:54px 42px;background:#d7ff38;color:#090a08"><div style="font-size:10px;font-weight:bold;letter-spacing:2px">FRAGEN ZUR RECHNUNG?</div><div style="padding-top:15px;font-family:Georgia,serif;font-size:35px;line-height:1.05;font-style:italic;letter-spacing:-1px">Melde dich<br>direkt bei HEAV.</div><div style="padding-top:22px;font-size:15px">Freundliche Grüsse<br><strong>${owner}</strong><br>${company}</div></td></tr><tr><td class="pad" style="padding:28px 42px 34px;background:#090a08;color:#eeeae0"><table role="presentation" width="100%"><tr><td style="font-size:20px;font-weight:bold">HEAV<span style="color:#d7ff38">.</span></td><td align="right" style="font-size:9px;letter-spacing:1.5px;color:#aaa89f">FILMPRODUKTION · SCHWEIZ</td></tr><tr><td colspan="2" style="padding-top:18px;color:#aaa89f;font-size:12px;line-height:1.7"><strong style="color:#eeeae0">${company}</strong><br>${escapeHtml(settings.address_line1)} · ${escapeHtml(settings.postal_code)} ${escapeHtml(settings.city)}<br>${contactLinks}</td></tr></table></td></tr><tr><td style="height:8px;background:#d7ff38;font-size:0">&nbsp;</td></tr></table></td></tr></table></body></html>`;
}
